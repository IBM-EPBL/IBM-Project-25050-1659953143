...
COS_API_KEY_ID="YCU3hXEh6WspgkSxaAVaZmYbs5goIYN1ziPtpLcmE5bK"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/acbdff17a0d94e3fa1f077d5f3f9a78a:22c20e3a-65ae-4e13-ae0d-232cafe5f2fb::"
...
@app.route('/')
def index():
    files = get_bucket_contents('flaskapp125')
